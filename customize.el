(custom-set-variables
 ...
 '(warning-suppress-log-types
   '((initialization)
     ...
     (initialization)
     (comp)))
 '(warning-suppress-types '((initialization) (initialization) (comp))))
(custom-set-faces
