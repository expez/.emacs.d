...
(after-load 'neotree
  ...
  (add-hook 'neotree-mode-hook
            (lambda ()
              (define-key evil-normal-local-state-map (kbd "SPC")     'neotree-enter)
              (define-key evil-normal-local-state-map (kbd "TAB")     'neotree-enter)
              (define-key evil-normal-local-state-map (kbd "RET")     'neotree-enter)
              (define-key evil-normal-local-state-map (kbd "|")       'neotree-enter-vertical-split)
              (define-key evil-normal-local-state-map (kbd "-")       'neotree-enter-horizontal-split)
              (define-key evil-normal-local-state-map (kbd "g")       'neotree-refresh)
              (define-key evil-normal-local-state-map (kbd "q")       'neotree-hide)
              (define-key evil-normal-local-state-map (kbd "p")       'previous-line)
              (define-key evil-normal-local-state-map (kbd "n")       'next-line)
              (define-key evil-normal-local-state-map (kbd "A")       'neotree-stretch-toggle)
              (define-key evil-normal-local-state-map (kbd "U")       'neotree-select-up-node)
              (define-key evil-normal-local-state-map (kbd "D")       'neotree-select-down-node)
              (define-key evil-normal-local-state-map (kbd "H")       'neotree-hidden-file-toggle)
              (define-key evil-normal-local-state-map (kbd "S")       'neotree-select-previous-sibling-node)
              (define-key evil-normal-local-state-map (kbd "s")       'neotree-select-next-sibling-node)
              (define-key evil-normal-local-state-map (kbd "C-x C-f") 'find-file-other-window)
              (define-key evil-normal-local-state-map (kbd "C-x 1")   'neotree-empty-fn)
              (define-key evil-normal-local-state-map (kbd "C-x 2")   'neotree-empty-fn)
              (define-key evil-normal-local-state-map (kbd "C-x 3")   'neotree-empty-fn)
              (define-key evil-normal-local-state-map (kbd "C-c C-f") 'find-file-other-window)
              (define-key evil-normal-local-state-map (kbd "C-c C-c") 'neotree-change-root)
              (define-key evil-normal-local-state-map (kbd "C") 'neotree-change-root)
              (define-key evil-normal-local-state-map (kbd "c") 'neotree-create-node)
              (define-key evil-normal-local-state-map (kbd "+") 'neotree-create-node)
              (define-key evil-normal-local-state-map (kbd "d") 'neotree-delete-node)
              (define-key evil-normal-local-state-map (kbd "r") 'neotree-rename-node)
              (define-key evil-normal-local-state-map (kbd "e") 'neotree-enter)))
